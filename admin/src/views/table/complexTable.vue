  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.filters.curriculumCategory" :placeholder="$t('table.curriculums.curriculumCategory')" clearable class="filter-item" style="width: 130px">
        <el-option v-for="(item, index) in calendarTypeOptions" :key="index" :label="item.display_name+'('+item.key+')'" :value="item.key"/>
      </el-select>
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.curriculums.curriculumNo')" prop="id" sortable="custom" align="center" width="65">
      ...
      <el-table-column :label="$t('table.curriculums.startDate')" width="150px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.curriculums.applicantsInserted')" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.applicantsInserted }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.curriculums.membersInserted')" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.membersInserted }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.curriculums.insertedTimestamp')" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.insertedTimestamp }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.curriculums.updatedTimestamp')" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.updatedTimestamp }}</span>
        </template>
      </el-table-column>
    </el-table>
  ...
  data() {
    return {
      ...
      listQuery: {
        ...
        sort: { column: 'startDate', option: 'asc' },
        page: 1,
        limit: 20
      },
      importanceOptions: [1, 2, 3],
      calendarTypeOptions,
      sortOptions: [{ label: 'startDate Ascending', key: { column: 'startDate', option: 'asc' }}, { label: 'startDate Descending', key: { column: 'startDate', option: 'desc' }}],
